...
import pt.psoft.g1.psoftg1.authormanagement.services.CreateAuthorWithBookRequest;
...
//    private final BookViewMapper bookViewMapper;
    ...
    // Create Author with book information
    @Operation(summary = "Creates a new Author with book information")
    @PostMapping("/withbook")
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseEntity<AuthorView> createWithBookInfo(@Valid CreateAuthorWithBookRequest resource) {

        System.out.println("Received name: " + resource.getName());
        ...
        final var author = authorService.createWithBookInfo(resource);
    ...
    public ResponseEntity<AuthorView> partialUpdate(
        ...
        Author author = authorService.partialUpdate(resource,
