...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .requestMatchers(HttpMethod.POST, "/api/genres").hasRole(Role.LIBRARIAN)
                .requestMatchers(HttpMethod.POST, "/api/suggest/isbn").hasRole(Role.READER)
                .requestMatchers(HttpMethod.PUT, "/api/suggest/{suggestId}/approve").hasRole(Role.LIBRARIAN)
                // endBooks
//                // genres
